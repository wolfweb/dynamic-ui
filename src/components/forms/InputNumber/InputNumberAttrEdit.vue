<template>
  <el-form ref="form" :model="element!" label-width="20%">
    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <el-form-item label="最大值" prop="attributes.min">
          <el-input-number style="width: 100%;" v-model="element!.attributes.min" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="24">
        <el-form-item label="最小值" prop="attributes.max">
          <el-input-number style="width: 100%;" v-model="element!.attributes.max" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="24">
        <el-form-item label="数值精度" prop="attributes.precision">
          <el-input-number style="width: 100%;" v-model="element!.attributes.precision" />
        </el-form-item>
      </el-col>
    </el-row>
