    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <el-form-item label="类型" prop="attributes.type">
          <el-select v-model="widget!.attributes.type" placeholder="请选择" style="width: 100%;" @change="typeChangeHandle">
            <el-option v-for="item in typeList" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row v-if="widget!.attributes.type!='hidden'">
      <el-col :span="24">
    ...
    <el-row v-if="widget!.attributes.type!='hidden'">
      <el-col :span="24">
        <el-form-item label="显示字限" prop="attributes['show-word-limit']">
          <el-switch v-model="widget!.attributes['show-word-limit']" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row v-if="widget!.attributes.type=='password'">
      <el-col :span="24">
        <el-form-item label="显示密码" prop="attributes['show-password']">
          <el-switch v-model="widget!.attributes['show-password']" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="20" v-if="widget!.attributes.type!='hidden'">
      <el-col :span="24">
        <el-form-item label="最大长度" prop="attributes.maxlength">
          <el-input-number style="width: 100%;" v-model="widget!.attributes.maxlength" :min="0" :step="1" step-strictly />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="20" v-if="widget!.attributes.type!='hidden'">
      <el-col :span="24">
        <el-form-item label="最小长度" prop="attributes.minlength">
          <el-input-number style="width: 100%;" v-model="widget!.attributes.minlength" :min="0" :step="1" step-strictly />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row v-if="widget!.attributes.type!='hidden'">
